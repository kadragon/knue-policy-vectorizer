...
from src.embedding_service import EmbeddingError, EmbeddingService
...
class TestEmbeddingService:
    ...
    def test_generate_embedding_success(
        self, mock_ollama, embedding_service, sample_text
    ):
    ...
    @patch("src.embedding_service.OllamaEmbeddings")
    def test_generate_embedding_ollama_error(
        self, mock_ollama, embedding_service, sample_text
    ):
    ...
    @patch("src.embedding_service.tiktoken")
    def test_validate_token_limit_success(
        self, mock_tiktoken, embedding_service, sample_text
    ):
    ...
    def test_validate_token_limit_exceeded(
        self, mock_tiktoken, embedding_service, sample_long_text
    ):
    ...
    @patch("src.embedding_service.OllamaEmbeddings")
    def test_generate_embedding_with_validation(
        self, mock_ollama, embedding_service, sample_text
    ):
    ...
    def test_generate_embeddings_batch(self, mock_ollama, embedding_service):
        ...
        texts = ["첫 번째 문서입니다.", "두 번째 문서입니다.", "세 번째 문서입니다."]
...
class TestEmbeddingServiceIntegration:
    ...
    def test_actual_batch_embedding(self, embedding_service):
        ...
        texts = ["첫 번째 정책 문서", "두 번째 정책 문서", "세 번째 정책 문서"]
