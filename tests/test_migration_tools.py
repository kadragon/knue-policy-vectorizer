...
class TestMigrationManager:
    ...
    def test_check_compatibility_success(self, mock_factory):
        ...
        mock_factory_instance.get_embedding_service.side_effect = [
            mock_source_embedding, mock_target_embedding
        ]
        mock_factory_instance.get_vector_service.side_effect = [
            mock_source_vector, mock_target_vector
        ]
    ...
    def test_compare_performance(self, mock_factory):
        ...
        mock_source_embedding.generate_embeddings_batch.return_value = [[0.1] * 1024, [0.2] * 1024]
        mock_target_embedding.generate_embeddings_batch.return_value = [[0.3] * 1536, [0.4] * 1536]
