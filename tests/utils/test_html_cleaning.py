...
@pytest.mark.unit
def test_strip_html_cleans_lists_and_tags_and_preserves_text_tokens() -> None:
    raw = (
    ...
    config = Config(
        ...
        qdrant_cloud_url="http://test",
        qdrant_api_key="test_key",
    )
    ing = KnueBoardIngestor(config=config)
...
@pytest.mark.unit
def test_strip_html_removes_olli_artifacts() -> None:
    raw = (
...
@pytest.mark.unit
def test_strip_html_removes_residual_tag_tokens_and_icons() -> None:
    raw = (
