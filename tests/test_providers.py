...
class TestProviderFactory:
    ...
    def test_get_embedding_service_openai(self):
        ...
        with patch.object(factory, '_create_openai_embedding_service') as mock_create:
            ...
            assert service == mock_instance
            mock_create.assert_called_once_with({"api_key": "test-key", "model": "text-embedding-3-small"})
    ...
    def test_get_vector_service_qdrant_cloud(self):
        ...
        with patch.object(factory, '_create_qdrant_cloud_service') as mock_create:
            ...
            assert service == mock_instance
            mock_create.assert_called_once_with({"url": "https://test.qdrant.tech", "api_key": "test-key"})
...
class TestProviderConfigValidation:
    ...
    def test_ollama_config_validation(self):
        ...
        assert not factory.validate_embedding_config(EmbeddingProvider.OLLAMA, invalid_config)
    ...
    def test_openai_config_validation(self):
        ...
        assert not factory.validate_embedding_config(EmbeddingProvider.OPENAI, invalid_config)
    ...
    def test_qdrant_local_config_validation(self):
        ...
        # Missing URL
        invalid_config = {}
        assert not factory.validate_vector_config(VectorProvider.QDRANT_LOCAL, invalid_config)
    ...
    def test_qdrant_cloud_config_validation(self):
        ...
        assert not factory.validate_vector_config(VectorProvider.QDRANT_CLOUD, invalid_config)