...
class OpenAIEmbeddingService(EmbeddingServiceInterface):
    ...
    def generate_embedding(self, text: str) -> List[float]:
        ...
        try:
            ...
            raise OpenAIEmbeddingError(f"Unexpected error during embedding generation: {e}")
    ...
    def _generate_batch_chunk(self, texts: List[str]) -> List[List[float]]:
        ...
        try:
            ...
            raise OpenAIEmbeddingError(f"Unexpected error during batch embedding generation: {e}")
    ...
    def health_check(self) -> bool:
        ...
        try:
            ...
            is_healthy = (
                ...
                len(test_embedding) == self.embedding_dimension and
                all(isinstance(x, (int, float)) for x in test_embedding)
            )
