...
def test_qdrant_integration():
    ...
    try:
        ...
        qdrant_service = QdrantService(
            collection_name=test_collection, vector_size=1024
        )
        ...
        for file_path in test_files:
            ...
            if doc:
                ...
                if "document_id" not in doc:
                    doc["document_id"] = markdown_processor.calculate_document_id(
                        str(file_path)
                    )
        ...
        for doc in processed_docs:
            try:
                ...
                embeddings_data.append({"doc": doc, "embedding": embedding})
        ...
        print(
            f"✅ Generated {len(embeddings_data)} embeddings in {embedding_time:.2f}s"
        )
        ...
        for data in embeddings_data:
            ...
            try:
                success = qdrant_service.upsert_point(
                    point_id=doc["document_id"], vector=embedding, metadata=doc
                )
        ...
        try:
            ...
            if collection_info["vectors_count"] == stored_count:
                ...
                print(
                    f"⚠️  Expected {stored_count}, found {collection_info['vectors_count']}"
                )
        ...
        if processed_docs:
            ...
            try:
                ...
                if retrieved_point:
                    ...
                    vector_len = (
                        len(retrieved_point.vector) if retrieved_point.vector else "N/A"
                    )
